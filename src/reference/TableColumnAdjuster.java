 ...
 */
public class TableColumnAdjuster extends JFrame implements PropertyChangeListener, TableModelListener
{
	/**
	 * 
	 */
...
//
	...
	public static void main(String[] args) {
		...
		JTable table1 = frame.getTable();
		new TableColumnAdjuster(table1, 50);
